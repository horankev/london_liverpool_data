...
This particular file appears as a collection of shapefiles in zipped form [here](https://data.london.gov.uk/dataset/statistical-gis-boundary-files-london as a zipped set of shapefiles called: statistical-gis-boundaries-london.zip).
...
The river Mersey dataset in the Liverpool region comes from the UK Government Environment Agency's [data services platform](https://environment.data.gov.uk/catchment-planning/WaterBody/GB531206908100)
